...
class Pruebaa extends StatefulWidget {
  final LatLng? initialTarget;
  const Pruebaa({super.key, this.initialTarget});

  @override
  State<Pruebaa> createState() => _PruebaaState();
}

class _PruebaaState extends State<Pruebaa> {
  ...
  void initState() {
    ...
    //   _selectedPosition = widget.initialTarget!;
